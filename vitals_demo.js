...
//linking to demo slider, these handlers will interface (somehow) with medical devices
var hr_slider = document.getElementById("hr_slider");
...
var bpin_slider = document.getElementById("bpin_slider");
bpin_slider.oninput = function() {
	var x = Number.parseFloat(this.value);
	if(!isNaN(x))
		vitals.setBPIn(x);
}

var bpout_slider = document.getElementById("bpout_slider");
bpout_slider.oninput = function() {
	var x = Number.parseFloat(this.value);
	if(!isNaN(x))
		vitals.setBPOut(x);
}

var spo2_slider = document.getElementById("spo2_slider");
...
rr_slider.oninput = function() {
	var x = Number.parseFloat(this.value);
	if(!isNaN(x))
		vitals.setBRPM(x);
}

var tmp_slider = document.getElementById("tmp_slider");
tmp_slider.oninput = function() {
	var x = Number.parseFloat(this.value);
	if(!isNaN(x))
		vitals.setTmp(x);
}